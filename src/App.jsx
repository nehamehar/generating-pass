...
Use Tailwind’s responsive prefixes (sm:, md:, lg: etc.) to add or override styles for bigger screens. */}
  <footer className="w-full py-4 text-base px-7 center bg-slate-800 text-slate-400">
    <div className="flex flex-col gap-4 p-2 text-center text-gray-300 bg-gray-800 lg:ml-48 sm:flex-row sm:justify-between sm:px-8 lg:px-16">
